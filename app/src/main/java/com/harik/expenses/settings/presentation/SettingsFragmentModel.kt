...
import com.harik.expenses.data.preference.PreferenceDataSource
import com.harik.expenses.settings.work.ExpenseDeletionWorker
import com.harik.expenses.settings.work.ExpenseExportWorker
...
class SettingsFragmentModel(
    ...
    private fun loadItemModels() {
        itemModels.value = createExpenseSection()
    }
